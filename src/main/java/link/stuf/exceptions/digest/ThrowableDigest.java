...
public class ThrowableDigest extends AbstractHashed {
    ...
    ThrowableDigest(Throwable throwable, ThrowableDigest cause, Clock clock) {
        this(
    ...
    public Throwable toException(Throwable cause) {
    ...
    public ThrowableDigest withStacktrace(List<StackTraceElement> stackTrace) {
