...
final class DefaultMeta implements Meta {
    ...
    DefaultMeta(
        Method method,
        Function<Object, byte[]> writer,
        BiFunction<Class<?>, InputStream, Object> reader
    ) {
        ...
        this.returnType = getActualReturnType(method, this.optional, returnType);
    ...
    @Override
    public Object response(InputStream inputStream) {
    ...
    private static String toString(Object arg) {
        return arg instanceof IdDto ? ((IdDto) arg).uuid.toString() : arg.toString();
    }
