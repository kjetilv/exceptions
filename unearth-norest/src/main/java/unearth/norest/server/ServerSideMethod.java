...
final class ServerSideMethod extends AbstractProcessedMethod {
    
    ServerSideMethod(Method method, Transformers transformers) {
    ...
    public Optional<Function<Object, Object>> invocation(Request request) {
        ...
        return Optional.of(matchPattern().matcher(path))
            .filter(Matcher::matches)
            .map(matcher ->
                invoker(request, matcher));
    }
    ...
    private Object invokeOn(Object impl, Object[] args) {
        Object result = call(impl, args);
        return result == null || nullReturn() ? null
            : optionalReturn() ? optional(result)
                : result;
    }
    
    private Object optional(Object result) {
    ...
    private Object call(Object impl, Object[] args) {
        try {
